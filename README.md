...
![Header](https://capsule-render.vercel.app/api?type=waving&height=220&color=0:0F172A,45:2563EB,100:06B6D4&text=Manav%20Chaudhary&fontColor=FFFFFF&fontSize=48&fontAlignY=36&desc=Backend%20Developer%20%E2%80%A2%20Builder%20%E2%80%A2%20Tech%20Explorer&descAlignY=58&animation=fadeIn)
...
- 📚 Away from code, I'm an explorer and an avid reader
- 💬 Ask me about **Spring Boot, Docker, Telegram tooling, or FFmpeg**

## 🛠️ Tech stack

<div align="center">

[![My Skills](https://skillicons.dev/icons?i=java,spring,ts,js,docker,git,github,linux,maven&perline=9)](https://skillicons.dev)
...
### [🛍️ TrendyTraverse](https://github.com/manavchaudhary1/TrendyTraverse)

An e-commerce application built with Spring Boot and containerized with Docker.

`Spring Boot` `TypeScript` `Docker`

</td>
<td width="50%" valign="top">

### [✈️ TeleFetch](https://github.com/manavchaudhary1/TeleFetch)

A Spring Boot utility for downloading messages from private Telegram groups and channels.

`Java` `Spring Boot` `Telegram`
...
### [🎬 CLI-FFMPEG](https://github.com/manavchaudhary1/CLI-FFMPEG)

A cross-platform CLI that makes common FFmpeg tasks easier on Linux, WSL, and Windows.
...
### [🗂️ All repositories](https://github.com/manavchaudhary1?tab=repositories)

Explore the rest of my experiments, utilities, and learning projects.
...
If you like backend development, useful developer tools, or open-source experiments, feel free to explore my repositories and connect with me here on GitHub.
